...
impl From<u8> for ServerOpcode {
    fn from(op: u8) -> Self {
        match op {
            ...
            0x01 | 0x72 => ServerOpcode::MoveToLocation,
            0x03 => ServerOpcode::CharInfo,
            0x04 | 0x0b | 0x32 => ServerOpcode::UserInfo,
            0x05 => ServerOpcode::Attack,
            0x08 => ServerOpcode::DeleteObject,
            0x09 | 0x1f => ServerOpcode::CharSelectInfo,
            0x0c => ServerOpcode::ItemAction,
            0x0d => ServerOpcode::GetItem,
            0x0e | 0x18 => ServerOpcode::StatusUpdate,
            0x11 | 0x1b => ServerOpcode::ItemList,
            0x16 | 0xaf => ServerOpcode::NpcInfo,
            0x21 | 0x27 => ServerOpcode::InventoryUpdate,
            ...
            0x41 => ServerOpcode::WarehouseDepositList,
            0x42 => ServerOpcode::WarehouseWithdrawList,
            ...
            0x58 | 0x5f => ServerOpcode::SkillList,
            0x61 => ServerOpcode::ValidateLocation,
            0x64 => ServerOpcode::SystemMessage,
            0x6f => ServerOpcode::RestartResponse,
            0x7f => ServerOpcode::MagicEffectIcons,
            0x85 => ServerOpcode::AbnormalStatusUpdate,
            0x9b | 0xa1 => ServerOpcode::PrivateStoreListSell,
            0xb8 | 0xbe => ServerOpcode::PrivateStoreListBuy,
            0xdf => ServerOpcode::RecipeShopItemInfo,
