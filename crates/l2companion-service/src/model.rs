...
impl From<l2companion_protocol::WarehouseType> for WarehouseType {
    fn from(w: l2companion_protocol::WarehouseType) -> Self {
        match w {
            l2companion_protocol::WarehouseType::Private => WarehouseType::Private,
            l2companion_protocol::WarehouseType::Clan => WarehouseType::Clan,
            l2companion_protocol::WarehouseType::Castle => WarehouseType::Castle,
            l2companion_protocol::WarehouseType::Freight => WarehouseType::Freight,
            l2companion_protocol::WarehouseType::Package => WarehouseType::Package,
        }
    }
}
...
impl From<l2companion_protocol::PrivateStoreType> for PrivateStoreType {
    fn from(p: l2companion_protocol::PrivateStoreType) -> Self {
        match p {
            l2companion_protocol::PrivateStoreType::Sell => PrivateStoreType::Sell,
            l2companion_protocol::PrivateStoreType::Buy => PrivateStoreType::Buy,
            l2companion_protocol::PrivateStoreType::PackageSell => PrivateStoreType::PackageSell,
            l2companion_protocol::PrivateStoreType::Manufacture => PrivateStoreType::Manufacture,
        }
    }
}
...
impl From<l2companion_protocol::CharSelectSlot> for CharSelectSlot {
    fn from(s: l2companion_protocol::CharSelectSlot) -> Self {
        Self {
            name: s.name,
            title: s.title,
            char_id: s.char_id,
...
impl From<l2companion_protocol::ItemInfo> for InventoryItem {
    fn from(i: l2companion_protocol::ItemInfo) -> Self {
        Self {
...
impl From<l2companion_protocol::SkillEntry> for SkillEntry {
    fn from(s: l2companion_protocol::SkillEntry) -> Self {
        Self {
            skill_id: s.skill_id,
            level: s.level,
...
impl From<l2companion_protocol::BuffEffect> for BuffEffect {
    fn from(b: l2companion_protocol::BuffEffect) -> Self {
        Self {
            skill_id: b.skill_id,
            level: b.level,
...
impl From<l2companion_protocol::PrivateStoreItem> for PrivateStoreItem {
    fn from(p: l2companion_protocol::PrivateStoreItem) -> Self {
        Self {
...
impl From<l2companion_protocol::CommissionItem> for CommissionItem {
    fn from(c: l2companion_protocol::CommissionItem) -> Self {
        Self {
...
impl From<l2companion_protocol::WorldExchangeItem> for WorldExchangeItem {
    fn from(w: l2companion_protocol::WorldExchangeItem) -> Self {
        Self {
...
impl From<l2companion_protocol::EinhasadProduct> for EinhasadProduct {
    fn from(e: l2companion_protocol::EinhasadProduct) -> Self {
        Self {
